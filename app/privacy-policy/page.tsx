        ...
        <div className="grid gap-8 lg:grid-cols-[260px_1fr]">
          ...
          <div className="space-y-3">
            {sections.map((section) => (
              ...
              >
                <h3 className="flex items-center gap-2.5 text-lg font-semibold mb-3" style={{ color: "var(--text-primary)" }}>
                  <Lock className="w-[18px] h-[18px] shrink-0" style={{ color: "var(--brand-accent)" }} />
                  {section.title}
                </h3>
