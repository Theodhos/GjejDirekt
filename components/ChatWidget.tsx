    ...
    <>
      {!open && (
        <button
          ...
          aria-label={c.open}
          className="fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full px-5 py-4 text-white font-bold text-sm shadow-lg transition-transform hover:scale-105 active:scale-95"
      ...
      {open && (
        <div
          className="fixed bottom-6 right-6 z-50 flex flex-col w-[calc(100vw-3rem)] sm:w-[380px] h-[560px] max-h-[calc(100vh-3rem)] animate-in fade-in slide-in-from-bottom-4 duration-300"
