...
/**
 * Price tile inside the listing "Details" grid. The label follows the language, so the
 * tile lives in a client component while the page stays server-rendered.
 */
export default function ListingPriceTile({ price }: { price: number }) {
