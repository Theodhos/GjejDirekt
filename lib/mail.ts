  ...
  const html = `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 20px;">
      ...
      <div style="background-color: #f8fafc; padding: 20px; border-radius: 15px; margin: 20px 0;">
        ...
        <blockquote style="margin: 0; padding: 10px 20px; border-left: 4px solid #ef4444; background: #fff; font-style: italic; color: #475569;">
          "${reason}"
        </blockquote>
      </div>
      ...
      <p style="color: #94a3b8; font-size: 12px; margin-top: 40px; text-align: center;">
        Tourism Platform Moderation System &bull; This is an automated notification.
      </p>
    </div>
  `;
